...
def build_dict(path_root, path_indir, eventfiles, path_dict, path_dict2):
    ...
    pickle.dump((event2word, word2event), open(path_dict2, 'wb'), protocol=2)
...
if __name__ == '__main__':
    ...
    path_dict2 = os.path.join(path_root, 'dictionary_py2.pkl')
    ...
    if not os.path.exists(path_dict):
        build_dict(path_root, path_indir, eventfiles, path_dict, path_dict2)
