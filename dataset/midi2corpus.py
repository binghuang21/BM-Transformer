...
def proc_one(path_midi, path_outfile):
    ...
    for key in instr_notes.keys():
        ...
        for note in notes:
            ...
            # append
            note_grid[quant_time].append(note)    # append de dou shi dui qi hou de zheng TICK note, quant_time shi zheng TICK
    ...
    for chord in chords:
        ...
        quant_time = int(np.round(chord.time / TICK_RESOL) * TICK_RESOL)    # gui yi hua dao zheng TICK
...
if __name__ == '__main__':
     # paths
    path_indir = '/mnt/guided/plan2data/midi_analyzed'
    path_outdir = '/mnt/guided/plan2data/corpus-time/fixed'
